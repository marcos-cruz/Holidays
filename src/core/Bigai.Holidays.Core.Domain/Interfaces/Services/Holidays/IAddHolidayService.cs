...
namespace Bigai.Holidays.Core.Domain.Interfaces.Services.Holidays
{
    ...
    public interface IAddHolidayService : IDomainService
    {
        ...
        CommandResult Add(string countryIsoCode, int year);
        ...
        /// <param name="validate">Determines whether the list should be validated. Default <c>true</c>.</param>
        CommandResult AddRange(List<List<Holiday>> listOfListHolidays, bool validate = true);
        ...
        /// <param name="listOfListHolidays">List of <see cref="Holiday"/> lists to be added.</param>
        /// <param name="validate">Determines whether the list should be validated. Default <c>true</c>.</param>
        Task<CommandResult> AddRangeAsync(List<List<Holiday>> listOfListHolidays, bool validate = true);
    }
}
